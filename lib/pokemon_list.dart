...
import 'package:pokedex/pokemon_pageview.dart';
...
class PokemonList extends StatelessWidget {
    ...
    return Scaffold(
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return _gridViewPokemon(snapshot.data, context);
          } else {
  ...
  Widget _gridViewPokemon(List<PokemonNew> pokemons, BuildContext context) {
    return Padding(
          ...
          return GestureDetector(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => PokemonPageView(pokemons: pokemons, initialPage: index) ));
                  // PokemonDetails(pokemonNew:pokemons[index])
            },
            child: Padding(
